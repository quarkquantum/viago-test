...
export const AgencyRequests = () => {
  ...
  const legalFormLabel = (value?: string) => {
    ...
    const map: Record<string, string> = {
      sarl: 'table.legalFormOptions.sarl',
      sa: 'table.legalFormOptions.sa',
      gie: 'table.legalFormOptions.gie',
      ei: 'table.legalFormOptions.ei',
      SARL: 'table.legalFormOptions.sarl',
      SA: 'table.legalFormOptions.sa',
      GIE: 'table.legalFormOptions.gie',
      ENTREPRISE_INDIVIDUELLE: 'table.legalFormOptions.ei',
    };
