...
const billingHandler = new Hono<HonoEnv>().get(
  '/',
  ...BillingRoutes.listSubscriptions,
  ...
  .patch(
    '/:id/suspend',
    ...BillingRoutes.suspendSubscription,
    async (ctx) => {
