    ...
    <View style={styles.wrapper}>
      {showCancelButton && isExpanded && (
        <Animated.View style={[styles.cancelButtonContainer, cancelButtonAnimatedStyle]}>
          <TouchableOpacity activeOpacity={0.7} onPress={handleCancel} style={styles.cancelButton}>
      ...
      >
        {isExpanded ? (
          <>
            <TouchableOpacity activeOpacity={0.7} onPress={handleSearch} style={styles.expandedIconContainer}>
