...
export const NewCashierForm = ({ setOpenAction }: { setOpenAction: (open: boolean) => void }) => {
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)}>
      ...
      <DialogFooter className="mt-6">
        ...
        <Button disabled={createCashier.isPending} type="submit">
          {createCashier.isPending && <Loader2 className="mr-2 size-4 animate-spin" />}
