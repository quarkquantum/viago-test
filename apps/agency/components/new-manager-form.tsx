...
import { z } from 'zod';
import { useCreateManager } from '@/features/managers/api/use-create-manager';

export const NewManagerForm = ({ setOpenAction }: { setOpenAction: (open: boolean) => void }) => {
  ...
  return (
    <form onSubmit={form.handleSubmit((data) => createManager.mutate(data))}>
      <FieldGroup>
      ...
      <DialogFooter className="mt-6">
        ...
        <Button disabled={createManager.isPending} type="submit">
          {createManager.isPending && <Loader2 className="mr-2 size-4 animate-spin" />}
