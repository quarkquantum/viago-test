  ...
  <div className="flex w-full items-center">
    <div className="flex w-full items-center gap-2">
      ...
      <div className="flex flex-col text-left">
        {departure && <p className="text-muted-foreground text-xs">Departure</p>}
        {arrival && <p className="text-muted-foreground text-xs">Arrival</p>}
        <h1 className="font-semibold text-sm">{station.name}</h1>
        <p className="text-muted-foreground text-xs">{formatCurrency(station.startingPrice)}</p>
      </div>
    </div>
