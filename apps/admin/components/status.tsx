...
const statusClasses: Record<string, string> = {
  ...
  OVERDUE: 'px-3 bg-orange-100 text-orange-800',
  PAID: 'px-3 bg-emerald-100 text-emerald-800',
  PENDING: 'px-3 bg-yellow-100 text-yellow-800',
  TRIAL: 'px-3 bg-indigo-100 text-indigo-800',
  APPROVED: 'px-3 bg-primary/20 text-primary',
  REJECTED: 'px-3 bg-destructive/20 text-destructive/80',
